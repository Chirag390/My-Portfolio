        ...
        <footer style={{paddingTop:'2rem'}} className="bg-[#060606]">
            <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
                ...
                <div className="mx-auto w-full max-w-sm space-y-2">
                    <Link href={"mailto:chiraggoyalcg640@gmail.com"} className={`underline text-xl ${marhey.className}`}>chiraggoyalcg640@gmail.com</Link>
            ...
            <div className="container flex items-center px-4 md:px-6" >
                <div className="mx-auto flex items-center flex-col gap-1 text-xs">
                    <br/>
                    <p className="text-gray-500 dark:text-gray-400" alt="© 2024 Parth Kabra. All rights reserved">© 2025 Chirag Goyal. All rights reserved.</p>
